...
The version of Mattermost server to install. Defaults to `4.10.0`.
...
`mattermost-team-4.10.0-linux-amd64.tar.gz`.
...
`https://releases.mattermost.com/4.10.0/mattermost-team-4.10.0-linux-amd64.tar.gz`.
