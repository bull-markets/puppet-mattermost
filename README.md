...
The version of Mattermost server to install. Defaults to `4.5.0`.
...
`mattermost-team-4.5.0-linux-amd64.tar.gz`.
...
`https://releases.mattermost.com/4.5.0/mattermost-team-4.5.0-linux-amd64.tar.gz`.
