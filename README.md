...
The version of Mattermost server to install. Defaults to `4.4.3`.
...
`mattermost-team-4.4.3-linux-amd64.tar.gz`.
...
`https://releases.mattermost.com/4.4.3/mattermost-team-4.4.3-linux-amd64.tar.gz`.
