...
The version of Mattermost server to install. Defaults to `4.7.1`.
...
`mattermost-team-4.7.1-linux-amd64.tar.gz`.
...
`https://releases.mattermost.com/4.7.1/mattermost-team-4.7.1-linux-amd64.tar.gz`.
