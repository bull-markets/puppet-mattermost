...
The version of Mattermost server to install. Defaults to `5.0.1`.
...
`mattermost-team-5.0.1-linux-amd64.tar.gz`.
...
`https://releases.mattermost.com/5.0.1/mattermost-team-5.0.1-linux-amd64.tar.gz`.
