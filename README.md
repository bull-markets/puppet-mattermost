...
The version of Mattermost server to install. Defaults to `5.0.0`.
...
`mattermost-team-5.0.0-linux-amd64.tar.gz`.
...
`https://releases.mattermost.com/5.0.0/mattermost-team-5.0.0-linux-amd64.tar.gz`.
