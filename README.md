...
The version of Mattermost server to install. Defaults to `5.12.2`.
...
`mattermost-team-5.12.2-linux-amd64.tar.gz`.
...
`https://releases.mattermost.com/5.12.2/mattermost-team-5.12.2-linux-amd64.tar.gz`.
